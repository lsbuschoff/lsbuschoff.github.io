...
export const aboutMe: AboutMe = {
  ...
  description:
    `<p>I am a fourth year PhD student in cognitive science and machine learning under the supervision of Dr. Eric Schulz in the Institute for <a href='https://hcai-munich.com/'>Human-Centered AI</a> at Helmholtz AI, Munich Germany.</p>`,
